...
if($row['reply_by'] != $_SESSION['user_pid'] || $_SESSION['user_rank'] < 3) {
http_response_code(403);
echo '{"success":0,"errors":"You don\'t have permission to do that."}';
} else {
$deleteReply = 'UPDATE replies SET reply_is_spoiler = 1 WHERE reply_id = ' . mysqli_real_escape_string($link, $_GET['id']);
