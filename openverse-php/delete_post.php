...
echo '{"success":0,"errors":"You don\'t have permission to delete this post."}';
} else {
$deletePost = 'UPDATE posts SET post_status = 2 WHERE post_id = ' . mysqli_real_escape_string($link, $_GET['id']);
